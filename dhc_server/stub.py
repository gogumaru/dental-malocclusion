...
def stub_response(patient_id: str | None = "2018.08") -> Dict[str, Any]:
    return {
        ...
        # Contoh overlay NYATA (dipangkas) dari pasien 2018.08 -- mencakup semua
        # `role` supaya app bisa menguji renderer-nya lengkap saat masih di stub.
        ...
        "overlays": {
            ...
            "lateral_kanan": {"shapes": [
                ...
                {"kind": "box", "role": "anchor", "label": "canine",
                 "points": [[0.4012, 0.4699], [0.4812, 0.5863]]},
